...
const I18N = {
  ...
  'role.arbiter': { zh: '仲裁者', en: 'Arbiter' },
  'wb.roleTip': { zh: '讨论者=只动嘴；提案者=可产出变更；仲裁者=提案者 + 冲突整理与融合执行', en: 'Discussant = talk only; Proposer = can produce changes; Arbiter = proposer + conflict digest & merge execution' },
  'wb.roleNoWrite': { zh: '该引擎无安全写模式，只能作为讨论者', en: 'This engine has no safe write mode — discussant only' },
  ...
  'wb.helpArbiter': { zh: '仲裁者：提案者 + 冲突职责——多个变更打架时整理各方 pro/con 供你拍板，你选定后由它执行融合。', en: 'Arbiter: proposer + conflict duty — when changes clash, it digests each side\'s pros/cons for your call, then executes the merge you pick.' },
