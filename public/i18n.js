...
const I18N = {
  ...
  'wb.arbiterTip': { zh: '叠加职责，可配在任一能力上：冲突时整理各方 pro/con 供你拍板并执行融合。「讨论者+仲裁」=不提自己方案的纯裁判（利益回避最优）', en: 'Stackable duty on either capability: on conflicts, digests pro/con for your call and executes the merge. Discussant+Arbiter = a pure judge with no proposals of its own (best for impartiality)' },
